...
(function($, window, document) {
	 ...
	 * Purpose:  Container for customizable parts of DataTables
	 * Scope:    jQuery.fn
	 */
	$.fn.dataTableExt = {};
	 ...
	 * Returns:  -
	 * Inputs:   object:oInit - initialization options for the table
	 */
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 * Scope:    jQuery.dataTable.classSettings
			 * Note:     This variable can take for form of a 1D array, in which case the value and the 
